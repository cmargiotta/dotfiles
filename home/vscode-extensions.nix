  ...
  extensions = [
    {
      ...
      version = "1.7.1";
      sha256 = "0lbxsbhf7y3qfjyilgyhqw0yd2fa08qcikc8n58g6m71b4ybh3d7";
    }
    {
      name = "cpp-helper";
      publisher = "amiralizadeh9480";
      version = "0.3.3";
      sha256 = "1qhddlvs6zm2cpsh6rfp06nyps54pn88w1fany6rlyicnsllxbiq";
    }
    {
      name = "Nix";
      publisher = "bbenoist";
    ...
    }
    {
      ...
      publisher = "ms-vscode";
      version = "1.18.3";
      sha256 = "sha256-Z7J1tnRcu9+TjNwcwtZSPsOT42qmTeRnDE2Ab/cJxG8=";
    }
    {
      name = "platformio-ide";
    ...
    }
    {
      ...
      publisher = "rust-lang";
      version = "0.4.1731";
      sha256 = "sha256-Xu7jAk0j+t3dX3F9Lgs01t0afmwQGVWqn+BXOuWlMeY=";
    }
    {
      name = "ReactSnippets";
      publisher = "xabikos";
